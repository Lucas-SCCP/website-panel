...
export default function FormComponent(props: { component: ComponentType }) {
  ...
  return (
    props.component.elements.content.map((element, index) => (
      <Accordion.Item key={index} eventKey={index.toString()}>
        <Accordion.Header>
          ...
          <span className="ms-auto website-accordion-header-action-buttons">
            <OverlayTrigger
              placement="bottom"
              overlay={
                <Tooltip id="tooltip-delete-element">
                  Excluir elemento
                </Tooltip>
              }
            >
          ...
          <span className="ms-auto website-accordion-header-action-buttons">
            <OverlayTrigger
              placement="bottom"
              overlay={
                <Tooltip id="tooltip-duplicate-element">
                  Duplicar elemento
                </Tooltip>
              }
            >
          ...
          <span className="ms-auto website-accordion-header-action-buttons">
            <OverlayTrigger
              placement="bottom"
              overlay={
                <Tooltip id="tooltip-drag-element">
        ...
        <Accordion.Body>
          {elementFactory(element.element_type_id, element)}
        </Accordion.Body>
      </Accordion.Item>
    ))
  )
